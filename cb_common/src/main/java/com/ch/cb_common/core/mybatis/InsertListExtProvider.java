 ...
 *   @Version    V1.0
 *   @Date:   2019年05月20日 11时58分
 *   Modification       History:
 *   ------------------------------------------------------------------------------------
 *   Date                  Author        Version        Discription
 *   -----------------------------------------------------------------------------------
 *  2019-05-20 11:58:37    fengzijk         1.0         Why & What is modified: <修改原因描述>
 *
 *
 */
 ...
 * @date 2020/4/12
 */
public class InsertListExtProvider extends MapperTemplate {


    public InsertListExtProvider(Class<?> mapperClass, MapperHelper mapperHelper) {
